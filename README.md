...
services:
  littlelink-server:
    ...
    environment:
      - META_TITLE=Dahyuk C.
      - META_DESCRIPTION=Student | Self-hosted | Homelab | Korean
      - META_AUTHOR=Dahyuk Choi
      - META_KEYWORDS=HomeLab, HTML, CSS, Vercel, Docker
      - LANG=ko
      - META_INDEX_STATUS=all
      - OG_SITE_NAME=Dahyuk C.
      - OG_TITLE=Dahyuk C.
      - OG_DESCRIPTION=The home of Dahyuk
      - OG_URL=https://social.dahy.uk
      - OG_IMAGE=https://i.ibb.co/XxkCPf3/Dahyuk-400x400.jpg
      - OG_IMAGE_WIDTH=400
      - OG_IMAGE_HEIGHT=400
      - GA_TRACKING_ID=G-XXXXXXXXXX
      - THEME=Dark
      - FAVICON_URL=https://i.ibb.co/5TnwdX0/Dahyuk-200x200.jpg
      - AVATAR_URL=https://i.ibb.co/5TnwdX0/Dahyuk-200x200.jpg
      - AVATAR_2X_URL=https://i.ibb.co/XxkCPf3/Dahyuk-400x400.jpg
      - AVATAR_ALT=Dahyuk Choi Profile Pic
      - NAME=DahyukC
      - BIO=Hey! Just a place where you can connect with me!
      # use ENV variable names for order, listed buttons will be boosted to the top
      - BUTTON_ORDER=GITHUB,BLOG
      # you can render an unlimited amount of custom buttons by adding 
      # the CUSTOM_BUTTON_* variables and by using a comma as a separator.
      - CUSTOM_BUTTON_TEXT=Blog
      - CUSTOM_BUTTON_URL=https://dahy.uk
      - CUSTOM_BUTTON_COLOR=#000000,#000000
      - CUSTOM_BUTTON_TEXT_COLOR=#ffffff,#ffffff
      - CUSTOM_BUTTON_ALT_TEXT=Blog about self-hosting and homelab
      - CUSTOM_BUTTON_NAME=BLOG
      - CUSTOM_BUTTON_ICON=fa-brands fa-blogger
      - GITHUB=https://github.com/devdahyuk
      - FOOTER=Dahyuk C. © 2022
    ports:
      - 8080:3000
